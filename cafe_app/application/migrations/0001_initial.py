# Generated by Django 4.2.1 on 2024-01-10 13:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.customer', verbose_name='Customer')),
            ],
            options={
                'db_table': 'order',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('order_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.order', verbose_name='Order')),
                ('payment_type_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.paymenttype', verbose_name='Payment type')),
            ],
            options={
                'db_table': 'Payment',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('order_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.order', verbose_name='Order')),
                ('product_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='application.product', verbose_name='Product')),
            ],
            options={
